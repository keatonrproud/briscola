...
class BriscolaCLI(BriscolaGame):
    ...
    def print_briscola(self) -> None:
        logger.info(f"Briscola Card: {self.briscola_card}\n")

    def print_played_cards(self) -> None:
        logger.info(f"PILE: {self.active_pile}\n")

    def print_game_state(self) -> None:
        logger.info(f"{len(self.deck.cards)}🃏 remain")
        logger.info(
    ...
    def start_turn(self) -> None:
        logger.debug(f"Briscola is {self.briscola_card}")
